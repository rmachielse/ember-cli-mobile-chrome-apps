module.exports = {
  ...
  run: function(options) {
    ...
    return new Promise(function(resolve, reject){
      cmd(cca, ['prepare'], {
        cwd: _this.project.root + '/external/cordova',
        ...
        cmd(cca, args, {
          ...
          _this.ui.writeLine(chalk.green('Built ' + options.platform + ' app succesfully. Stored in "external/cordova/platforms/' + options.platform + '/build/outputs/apk"'));
